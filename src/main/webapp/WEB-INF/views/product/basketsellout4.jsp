...
<form action="productsell" method="post" id="paymentForm">
  ...
  <div class="product_sellform2">
  	 <div class="input_group">
	      <div class="sell">
				...
				<br>
				<input type="hidden" value="" id="guestbuysu">
				<input type="hidden" value="" id="sname">
				<input type="button" value="결 제" id="submit_btn" data-guestbuysu="${guestbuysu}" data-sname="${sname}"onclick="submitForm(this)">
      	  </div>
  	</div> 
	</div>
</div>
